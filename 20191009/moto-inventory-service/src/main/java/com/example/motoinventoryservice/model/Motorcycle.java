...
public class Motorcycle {
    ...
    @Size(max = 20, message = "VIN maximum is 20 characters in length.")
    private String vin;
    @NotEmpty(message = "You must supply a value for make.")
    @Size(max = 20, message = "Make maximum is 20 characters in length.")
    private String make;
    @NotEmpty(message = "You must supply a value for model.")
    @Size(max = 20, message = "Model maximum is 20 characters in length.")
    ...
    @Size(max = 20, message = "Color maximum is 20 characters in length.")
