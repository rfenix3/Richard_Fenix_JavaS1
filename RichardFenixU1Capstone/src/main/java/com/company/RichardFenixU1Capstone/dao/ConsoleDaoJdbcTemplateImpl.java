...
public class ConsoleDaoJdbcTemplateImpl implements ConsoleDao {
    ...
    public Console getConsole(int id) {
        try {
            ...
            // if there is no Console with this id, just return null
            return null;
        }
    }
    ...
    public void updateConsole(Console console) {
        jdbcTemplate.update(UPDATE_CONSOLE_SQL, console.getModel(), console.getManufacturer(), console.getMemoryAmount(),
                console.getProcessor(), console.getPrice(), console.getQuantity(), console.getConsoleId());
