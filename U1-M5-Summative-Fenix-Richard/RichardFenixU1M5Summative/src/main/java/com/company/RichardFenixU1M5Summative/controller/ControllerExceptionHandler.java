...
public class ControllerExceptionHandler {
    ...
    public ResponseEntity<VndErrors> bookStoreValidationError(MethodArgumentNotValidException e, WebRequest request) {
    ...
    @ResponseStatus(HttpStatus.UNPROCESSABLE_ENTITY)
    public ResponseEntity<VndErrors.VndError> bookStoreValidationError(NumberFormatException e, WebRequest request) {
